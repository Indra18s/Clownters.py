...
def links():
    if platform.system() == 'Linux':
        os.system  ('xdg-open https://guns.lol/indra132jd &>/dev/null; clear')
        time.sleep(1)
        os.system('xdg-open https://discord.gg/v6vcY9kYny &>/dev/null; clear')
        time.sleep(1)
        os.system('xdg-open https://github.com/indra18s &>/dev/null; clear')
        time.sleep(1)
    else:
        webbrowser.open('https://guns.lol/indra132jd')
        time.sleep(1)
        webbrowser.open('https://discord.gg/v6vcY9kYny')
        time.sleep(1)
        webbrowser.open('https://github.com/indra18s')


def banner():
    clear()
    banner = ["\n \033[1;33m" ".--------.____________", "|| ° ° ° °     .2025.|| \033[1;32m®\033[1;33m", "||                    | \033[1;32m©\033[1;33m", "||\     ______________________", "|| \   // ° ° ° ° ° ° ° ° ° °/", "||\ \ //                    /", "|| \ //                    /", "||\ //                    /", "|| //                    /", "||//                    /", "||/                    /", "|/____________________/", "\033[1;31mArquivo IndraHack \033[m\n", "\033[1;35m<<<   PAINEL IndraHack " + str(datetime.date.today()) + "   >>>", "\033[1;32m=======================================\n"]
    for i in banner:
        print('', i)
        time.sleep(0.01)
